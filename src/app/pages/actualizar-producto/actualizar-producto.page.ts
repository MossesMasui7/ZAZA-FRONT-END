...
export class ActualizarProductoPage implements OnInit {
  ...
  constructor(public actualizacion:ProductoService, private camera:Camera,
  private alertController :AlertController) { }

  ngOnInit() {
  }
  actualizar(nombre,marca,modelo,descripcion) {
    this.actualizacion
      .actualizar(this.actualizacion.tiendas['_id'],nombre,marca,modelo,descripcion,this.Img)
      .then((data) => {
